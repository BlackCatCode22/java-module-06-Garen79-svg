...
public class DriverMain {
	...
	public static void main(String[] args) {
		...
		try (Scanner scanner = new Scanner(aFile)) {
			while (scanner.hasNextLine()) {
				...
				if (aLine.contains("Lion")) {
					// Sip the next line because it is a blank line.
					scanner.nextLine();
		...
		// Write to the file
		try (BufferedWriter writer = new BufferedWriter(new FileWriter( "C:/Users/arman/projectFile/zooPopulation.txt", true))) {
